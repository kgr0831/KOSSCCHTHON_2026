...
export type ProjectRequest = { id: string; project_id: string; opening_id: string; candidate_id: string; initiator_id: string; recipient_id: string; request_kind: "application" | "invitation"; message: string; status: string; revision: number };
