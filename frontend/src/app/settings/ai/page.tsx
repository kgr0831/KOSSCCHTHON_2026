...
type Providers = { api: { configured: boolean; models: string[]; error?: string }; cli: { claude_installed: boolean; gemini_installed: boolean }; consent_text: string };
